...
class App:
    ...
    def __init__(self, app_name, module=None, package=None, **kwargs):
        ...
        self.__conf_file__ = __conf_file__
        self.__ini_file__ = __ini_fname__
#         self.config = None
        self.confData = None
        ...
        try:
            ...
            logger=Logger.get_logger(self.cwd,self.appName,None,None,self.__conf_file__)
...
#             cfg_dict = aws_dict)
    ...
    def configure(Config):
        ...
        config = Config.get_configuration(self.__conf_file__)
...
#                     _log_name = module
    ...
    def get_logger(
        ...
        try:
            ...
            ''' assigning the last not None value of the three values as logger name '''
