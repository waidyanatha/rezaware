...
#             if self._dbUser is None and os.environment.get('NOSQLDB_DBUSER'):
#                 self._dbUser = os.environment.get('NOSQLDB_DBUSER')
...
#             if self._dbPswd is None and os.environment.get('NOSQLDB_DBPSWD'):
#                 self._dbPswd = os.environment.get('NOSQLdb_DBPSWD')
